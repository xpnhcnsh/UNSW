...
var f=this,h=!1;return{resolve:e(this.K),reject:e(this.l)}};
b.prototype.K=function(e){if(e===this)this.l(new TypeError("A Promise cannot resolve to itself"));else if(e instanceof b)this.M(e);else{a:switch(typeof e){case "object":var f=e!=null;break a;case "function":f=!0;break a;default:f=!1}f?this.J(e):this.m(e)}};
b.prototype.J=function(e){var f=void 0;try{f=e.then}catch(h){this.l(h);return}typeof f=="function"?this.N(f,e):this.m(e)};
b.prototype.l=function(e){this.A(2,e)};
b.prototype.m=function(e){this.A(1,e)};
b.prototype.A=function(e,f){if(this.h!=0)throw Error("Cannot settle("+e+", "+f+"): Promise already settled in state"+this.h);this.h=e;this.i=f;this.h===2&&this.L();this.T()};
b.prototype.L=function(){var e=this;g(function(){if(e.U()){var f=t.console;typeof f!=="undefined"&&f.error(e.i)}},1)};
b.prototype.U=function(){if(this.s)return!1;var e=t.CustomEvent,f=t.Event,h=t.dispatchEvent;if(typeof h==="undefined")return!0;typeof e==="function"?e=new e("unhandledrejection",{cancelable:!0}):typeof f==="function"?e=new f("unhandledrejection",{cancelable:!0}):(e=t.document.createEvent("CustomEvent"),e.initCustomEvent("unhandledrejection",!1,!0,e));e.promise=this;e.reason=this.i;return h(e)};
b.prototype.T=function(){if(this.g!=null){for(var e=0;e<this.g.length;++e)k.h(this.g[e]);this.g=null}};
var k=new c;b.prototype.M=function(e){var f=this.j();e.B(f.resolve,f.reject)};
b.prototype.N=function(e,f){var h=this.j();try{e.call(f,h.resolve,h.reject)}catch(l){h.reject(l)}};
...
var sa="closure_uid_"+(Math.random()*1E9>>>0),ta=0;function H(a,b){a=a.split(".");var c=F;a[0]in c||typeof c.execScript=="undefined"||c.execScript("var "+a[0]);for(var d;a.length&&(d=a.shift());)a.length||b===void 0?c[d]&&c[d]!==Object.prototype[d]?c=c[d]:c=c[d]={}:c[d]=b}
function ua(a,b){function c(){}
c.prototype=b.prototype;a.I=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.Z=function(d,g,k){for(var e=Array(arguments.length-2),f=2;f<arguments.length;f++)e[f-2]=arguments[f];return b.prototype[g].apply(d,e)}}
;var va=Array.prototype.indexOf?function(a,b){return Array.prototype.indexOf.call(a,b,void 0)}:function(a,b){if(typeof a==="string")return typeof b!=="string"||b.length!=1?-1:a.indexOf(b,0);
for(var c=0;c<a.length;c++)if(c in a&&a[c]===b)return c;return-1},wa=Array.prototype.forEach?function(a,b,c){Array.prototype.forEach.call(a,b,c)}:function(a,b,c){for(var d=a.length,g=typeof a==="string"?a.split(""):a,k=0;k<d;k++)k in g&&b.call(c,g[k],k,a)};
function xa(a,b){b=va(a,b);b>=0&&Array.prototype.splice.call(a,b,1)}
function ya(a){return Array.prototype.concat.apply([],arguments)}
function za(a){var b=a.length;if(b>0){for(var c=Array(b),d=0;d<b;d++)c[d]=a[d];return c}return[]}
;function Aa(a,b){this.i=a;this.j=b;this.h=0;this.g=null}
Aa.prototype.get=function(){if(this.h>0){this.h--;var a=this.g;this.g=a.next;a.next=null}else a=this.i();return a};var Ba;function Ca(){if(typeof MessageChannel!=="undefined"){var a=new MessageChannel,b={},c=b;a.port1.onmessage=function(){if(b.next!==void 0){b=b.next;var d=b.F;b.F=null;d()}};
return function(d){c.next={F:d};c=c.next;a.port2.postMessage(0)}}return function(d){F.setTimeout(d,0)}}
;function Da(a){F.setTimeout(function(){throw a;},0)}
;function Ea(){this.h=this.g=null}
Ea.prototype.add=function(a,b){var c=Fa.get();c.set(a,b);this.h?this.h.next=c:this.g=c;this.h=c};
Ea.prototype.remove=function(){var a=null;this.g&&(a=this.g,this.g=this.g.next,this.g||(this.h=null),a.next=null);return a};
var Fa=new Aa(function(){return new Ga},function(a){return a.reset()});
function Ga(){this.next=this.scope=this.g=null}
Ga.prototype.set=function(a,b){this.g=a;this.scope=b;this.next=null};
Ga.prototype.reset=function(){this.next=this.scope=this.g=null};var I,Ha=!1,Ia=new Ea;function Ja(a){I||Ka();Ha||(I(),Ha=!0);Ia.add(a,void 0)}
function Ka(){if(F.Promise&&F.Promise.resolve){var a=F.Promise.resolve(void 0);I=function(){a.then(La)}}else I=function(){var b=La;
Ba||(Ba=Ca());Ba(b)}}
function La(){for(var a;a=Ia.remove();){try{a.g.call(a.scope)}catch(c){Da(c)}var b=Fa;b.j(a);b.h<100&&(b.h++,a.next=b.g,b.g=a)}Ha=!1}
...
J.prototype.C=function(){if(this.j)for(;this.j.length;)this.j.shift()()};var Ma=/&/g,Na=/</g,Oa=/>/g,Pa=/"/g,Qa=/'/g,Ra=/\x00/g,Sa=/[\x00&<>"']/;/*
...
var Ta=new K("about:invalid#zClosurez");function Ua(a){this.S=a}
function L(a){return new Ua(function(b){return b.substr(0,a.length+1).toLowerCase()===a+":"})}
var Va=[L("data"),L("http"),L("https"),L("mailto"),L("ftp"),new Ua(function(a){return/^[^:]*([/?#]|$)/.test(a)})];
function Wa(a){var b=b===void 0?Va:b;a:if(b=b===void 0?Va:b,!(a instanceof K)){for(var c=0;c<b.length;++c){var d=b[c];if(d instanceof Ua&&d.S(a)){a=new K(a);break a}}a=void 0}return a||Ta}
var Xa=/^\s*(?!javascript:)(?:[\w+.-]+:|[^:/?#]*(?:[/?#]|$))/i;var Ya={Y:0,W:1,X:2,0:"FORMATTED_HTML_CONTENT",1:"EMBEDDED_INTERNAL_CONTENT",2:"EMBEDDED_TRUSTED_EXTERNAL_CONTENT"};function M(a,b){b=Error.call(this,a+" cannot be used with intent "+Ya[b]);this.message=b.message;"stack"in b&&(this.stack=b.stack);this.type=a;this.name="TypeCannotBeUsedWithIntentError"}
var N=Error;M.prototype=fa(N.prototype);M.prototype.constructor=M;if(ja)ja(M,N);else for(var O in N)if(O!="prototype")if(Object.defineProperties){var Za=Object.getOwnPropertyDescriptor(N,O);Za&&Object.defineProperty(M,O,Za)}else M[O]=N[O];M.I=N.prototype;
function $a(a,b){a.removeAttribute("srcdoc");var c="allow-same-origin allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-storage-access-by-user-activation".split(" ");a.setAttribute("sandbox","");for(var d=0;d<c.length;d++)a.sandbox.supports&&!a.sandbox.supports(c[d])||a.sandbox.add(c[d]);if(b instanceof K)if(b instanceof K)b=b.g;else throw Error("");else b=Xa.test(b)?b:void 0;b!==void 0&&(a.src=b)}
;function ab(a){Sa.test(a)&&(a.indexOf("&")!=-1&&(a=a.replace(Ma,"&amp;")),a.indexOf("<")!=-1&&(a=a.replace(Na,"&lt;")),a.indexOf(">")!=-1&&(a=a.replace(Oa,"&gt;")),a.indexOf('"')!=-1&&(a=a.replace(Pa,"&quot;")),a.indexOf("'")!=-1&&(a=a.replace(Qa,"&#39;")),a.indexOf("\x00")!=-1&&(a=a.replace(Ra,"&#0;")));return a}
;var bb,P;a:{for(var cb=["CLOSURE_FLAGS"],Q=F,db=0;db<cb.length;db++)if(Q=Q[cb[db]],Q==null){P=null;break a}P=Q}var eb=P&&P[610401301];bb=eb!=null?eb:!1;function R(){var a=F.navigator;return a&&(a=a.userAgent)?a:""}
var S,fb=F.navigator;S=fb?fb.userAgentData||null:null;function gb(){return bb?S?S.brands.some(function(a){return(a=a.brand)&&a.indexOf("Chromium")!=-1}):!1:!1}
;function hb(){return bb?!!S&&S.brands.length>0:!1}
function ib(a){var b={};a.forEach(function(c){b[c[0]]=c[1]});
return function(c){return b[c.find(function(d){return d in b})]||""}}
function jb(){for(var a=R(),b=RegExp("([A-Z][\\w ]+)/([^\\s]+)\\s*(?:\\((.*?)\\))?","g"),c=[],d;d=b.exec(a);)c.push([d[1],d[2],d[3]||void 0]);a=ib(c);return(hb()?gb():(R().indexOf("Chrome")!=-1||R().indexOf("CriOS")!=-1)&&(hb()||R().indexOf("Edge")==-1)||R().indexOf("Silk")!=-1)?a(["Chrome","CriOS","HeadlessChrome"]):""}
function kb(){if(hb()){var a=S.brands.find(function(b){return b.brand==="Chromium"});
if(!a||!a.version)return NaN;a=a.version.split(".")}else{a=jb();if(a==="")return NaN;a=a.split(".")}return a.length===0?NaN:Number(a[0])}
;function T(a){J.call(this);this.s=1;this.l=[];this.m=0;this.g=[];this.h={};this.A=!!a}
ua(T,J);q=T.prototype;q.subscribe=function(a,b,c){var d=this.h[a];d||(d=this.h[a]=[]);var g=this.s;this.g[g]=a;this.g[g+1]=b;this.g[g+2]=c;this.s=g+3;d.push(g);return g};
function lb(a,b,c){var d=U;if(a=d.h[a]){var g=d.g;(a=a.find(function(k){return g[k+1]==b&&g[k+2]==c}))&&d.D(a)}}
q.D=function(a){var b=this.g[a];if(b){var c=this.h[b];this.m!=0?(this.l.push(a),this.g[a+1]=function(){}):(c&&xa(c,a),delete this.g[a],delete this.g[a+1],delete this.g[a+2])}return!!b};
q.H=function(a,b){var c=this.h[a];if(c){for(var d=Array(arguments.length-1),g=1,k=arguments.length;g<k;g++)d[g-1]=arguments[g];if(this.A)for(g=0;g<c.length;g++){var e=c[g];mb(this.g[e+1],this.g[e+2],d)}else{this.m++;try{for(g=0,k=c.length;g<k&&!this.i;g++)e=c[g],this.g[e+1].apply(this.g[e+2],d)}finally{if(this.m--,this.l.length>0&&this.m==0)for(;c=this.l.pop();)this.D(c)}}return g!=0}return!1};
function mb(a,b,c){Ja(function(){a.apply(b,c)})}
q.clear=function(a){if(a){var b=this.h[a];b&&(b.forEach(this.D,this),delete this.h[a])}else this.g.length=0,this.h={}};
q.C=function(){T.I.C.call(this);this.clear();this.l.length=0};var nb=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function ob(a){var b=a.match(nb);a=b[1];var c=b[2],d=b[3];b=b[4];var g="";a&&(g+=a+":");d&&(g+="//",c&&(g+=c+"@"),g+=d,b&&(g+=":"+b));return g}
function pb(a,b,c){if(Array.isArray(b))for(var d=0;d<b.length;d++)pb(a,String(b[d]),c);else b!=null&&c.push(a+(b===""?"":"="+encodeURIComponent(String(b))))}
function qb(a){var b=[],c;for(c in a)pb(c,a[c],b);return b.join("&")}
var rb=/#|$/;var sb=["https://www.google.com"];function tb(){var a=this;this.g=[];this.h=function(){Promise.all(a.g.map(function(b){document.requestStorageAccessFor(b)})).then(function(){window.removeEventListener("click",a.h)})}}
function ub(){return pa(function(a){var b=a.return;var c=kb()>=119;return b.call(a,c&&!!navigator.permissions&&!!navigator.permissions.query&&"requestStorageAccessFor"in document)})}
function vb(){var a=new tb,b=["https://www.youtube.com"];b=b===void 0?sb:b;pa(function(c){switch(c.g){case 1:return C(c,ub(),2);case 2:if(!c.m){c.g=3;break}return C(c,Promise.all(b.map(function(d){var g;return pa(function(k){if(k.g==1)return k.l=2,C(k,navigator.permissions.query({name:"top-level-storage-access",requestedOrigin:d}),4);k.g!=2?(g=k.m,g.state==="prompt"&&a.g.push(d),k.g=0,k.l=0):(k.l=0,k.i=null,k.g=0)})})),4);
case 4:a.g.length>0&&window.addEventListener("click",a.h);case 3:return c.return()}})}
;var V={},wb=[],U=new T,xb={};function yb(){for(var a=v(wb),b=a.next();!b.done;b=a.next())b=b.value,b()}
function zb(a,b){return a.tagName.toLowerCase().substring(0,3)==="yt:"?a.getAttribute(b):a.dataset?a.dataset[b]:a.getAttribute("data-"+b)}
function Ab(a){U.H.apply(U,arguments)}
;function Bb(a){return(a.search("cue")===0||a.search("load")===0)&&a!=="loadModule"}
function Cb(a){return a.search("get")===0||a.search("is")===0}
;var W=window;
function X(a,b){this.v={};this.playerInfo={};this.videoTitle="";this.j=this.g=null;this.h=0;this.m=!1;this.l=[];this.i=null;this.A={};this.options=null;if(!a)throw Error("YouTube player element ID required.");this.id=ra(this);b=Object.assign({title:"video player",videoId:"",width:640,height:360},b||{});var c=document;if(a=typeof a==="string"?c.getElementById(a):a){W.yt_embedsEnableRsaforFromIframeApi&&vb();c=a.tagName.toLowerCase()==="iframe";b.host||(b.host=c?ob(a.src):"https://www.youtube.com");this.options=
b||{};b=[this.options,window.YTConfig||{}];for(var d=0;d<b.length;d++)b[d].host&&(b[d].host=b[d].host.toString().replace("http://","https://"));c||(b=Db(this,a),this.j=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b);this.g=a;this.g.id||(this.g.id="widget"+ra(this.g));V[this.g.id]=this;if(window.postMessage){this.i=new T;Eb(this);a=Y(this,"events");for(var g in a)a.hasOwnProperty(g)&&this.addEventListener(g,a[g]);for(var k in xb)xb.hasOwnProperty(k)&&Fb(this,k)}}}
...
if(!c)return this;this.i.subscribe(a,c);Gb(this,a);return this};
function Fb(a,b){b=b.split(".");if(b.length===2){var c=b[1];"player"===b[0]&&Gb(a,c)}}
...
function Hb(a,b,c){c=c||[];c=Array.prototype.slice.call(c);b={event:"command",func:b,args:c};a.m?a.sendMessage(b):a.l.push(b)}
function Db(a,b){var c=document.createElement("iframe");b=b.attributes;for(var d=0,g=b.length;d<g;d++){var k=b[d].value;k!=null&&k!==""&&k!=="null"&&c.setAttribute(b[d].name,k)}c.setAttribute("frameBorder","0");c.setAttribute("allowfullscreen","");c.setAttribute("allow","accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share");c.setAttribute("referrerPolicy","strict-origin-when-cross-origin");c.setAttribute("title","YouTube "+Y(a,"title"));(b=Y(a,"width"))&&
c.setAttribute("width",b.toString());(b=Y(a,"height"))&&c.setAttribute("height",b.toString());var e=Ib(a);e.enablejsapi=window.postMessage?1:0;window.location.host&&(e.origin=window.location.protocol+"//"+window.location.host);e.widgetid=a.id;window.location.href&&wa(["debugjs","debugcss"],function(f){var h=window.location.href;var l=h.search(rb);b:{var m=0;for(var n=f.length;(m=h.indexOf(f,m))>=0&&m<l;){var p=h.charCodeAt(m-1);if(p==38||p==63)if(p=h.charCodeAt(m+n),!p||p==61||p==38||p==35)break b;
...
W.yt_embedsEnableIframeApiSendFullEmbedUrl&&(window.location.href&&(e.forigin=window.location.href),b=window.location.ancestorOrigins,e.aoriginsup=b===void 0?0:1,b&&b.length>0&&(e.aorigins=Array.from(b).join(",")),window.document.referrer&&(e.gporigin=window.document.referrer));a=""+Y(a,"host")+Jb(a)+"?"+qb(e);W.yt_embedsEnableIframeSrcWithIntent?($a(c,Wa(a)),c.sandbox.add("allow-presentation","allow-top-navigation")):c.src=a;return c}
q.G=function(){this.g&&this.g.contentWindow?this.sendMessage({event:"listening"}):clearInterval(this.h)};
function Eb(a){Kb(a,a.id,String(Y(a,"host")));a.h=setInterval(a.G.bind(a),250);a.g&&(a.s=function(){clearInterval(a.h);a.h=setInterval(a.G.bind(a),250)},a.g.addEventListener("load",a.s))}
function Gb(a,b){a.A[b]||(a.A[b]=!0,Hb(a,"addEventListener",[b]))}
q.sendMessage=function(a){a.id=this.id;a.channel="widget";a=JSON.stringify(a);var b=ob(this.g.src||"").replace("http:","https:");if(this.g.contentWindow)try{this.g.contentWindow.postMessage(a,b)}catch(c){if(c.name&&c.name==="SyntaxError")c.message&&c.message.indexOf("target origin ''")>0||console&&console.warn&&console.warn(c);else throw c;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};
function Jb(a){if(W.yt_embedsEnableIframeApiVideoIdValidation){a=String(Y(a,"videoId"));if(a.includes("../"))throw Error("Invalid video id");return"/embed/"+a}return"/embed/"+String(Y(a,"videoId"))}
function Ib(a){var b=Y(a,"playerVars");if(b){var c={},d;for(d in b)c[d]=b[d];b=c}else b={};window!==window.top&&document.referrer&&(b.widget_referrer=document.referrer.substring(0,256));if(a=Y(a,"embedConfig")){if(G(a))try{a=JSON.stringify(a)}catch(g){console.error("Invalid embed config JSON",g)}b.embed_config=a}return b}
function Lb(a,b){if(G(b)){for(var c in b)b.hasOwnProperty(c)&&(a.playerInfo[c]=b[c]);a.playerInfo.hasOwnProperty("videoData")&&(b=a.playerInfo.videoData,b.hasOwnProperty("title")&&b.title?(b=b.title,b!==a.videoTitle&&(a.videoTitle=b,a.g.setAttribute("title",b))):(a.videoTitle="",a.g.setAttribute("title","YouTube "+Y(a,"title"))))}}
function Mb(a,b){b=v(b);for(var c=b.next(),d={};!c.done;d={u:void 0},c=b.next())d.u=c.value,a[d.u]||(d.u==="getCurrentTime"?a[d.u]=function(){var g=this.playerInfo.currentTime;if(this.playerInfo.playerState===1){var k=(Date.now()/1E3-this.playerInfo.currentTimeLastUpdated_)*this.playerInfo.playbackRate;k>0&&(g+=Math.min(k,1))}return g}:Bb(d.u)?a[d.u]=function(g){return function(){this.playerInfo={};
this.v={};Hb(this,g.u,arguments);return this}}(d):Cb(d.u)?a[d.u]=function(g){return function(){var k=g.u,e=0;
k.search("get")===0?e=3:k.search("is")===0&&(e=2);return this.playerInfo[k.charAt(e).toLowerCase()+k.substr(e+1)]}}(d):a[d.u]=function(g){return function(){Hb(this,g.u,arguments);
return this}}(d))}
q.getVideoEmbedCode=function(){var a=""+Y(this,"host")+Jb(this),b=Number(Y(this,"width")),c=Number(Y(this,"height"));if(isNaN(b)||isNaN(c))throw Error("Invalid width or height property");b=Math.floor(b);c=Math.floor(c);var d=this.videoTitle;a=ab(a);d=ab(d!=null?d:"YouTube video player");return'<iframe width="'+b+'" height="'+c+'" src="'+a+'" title="'+(d+'" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>')};
...
var Z=null,Nb=null;function Ob(a){if(a.tagName.toLowerCase()!=="iframe"){var b=zb(a,"videoid");b&&(b={videoId:b,width:zb(a,"width"),height:zb(a,"height")},new X(a,b))}}
function Kb(a,b,c){Z||(Z={},Nb=new Set,Pb.addEventListener("message",function(d){a:if(Nb.has(d.origin)){try{var g=JSON.parse(d.data)}catch(f){break a}var k=Z[g.id];if(k&&d.origin===k.O)switch(d=k.V,d.m=!0,d.m&&(wa(d.l,d.sendMessage,d),d.l.length=0),k=g.event,g=g.info,k){case "apiInfoDelivery":if(G(g))for(var e in g)g.hasOwnProperty(e)&&(d.v[e]=g[e]);break;case "infoDelivery":Lb(d,g);break;case "initialDelivery":G(g)&&(clearInterval(d.h),d.playerInfo={},d.v={},Mb(d,g.apiInterface),Lb(d,g));break;default:d.i.i||
(e={target:d,data:g},d.i.H(k,e),Ab("player."+k,e))}}}));
Z[b]={V:a,O:c};Nb.add(c)}
var Pb=window;H("YT.PlayerState.UNSTARTED",-1);H("YT.PlayerState.ENDED",0);H("YT.PlayerState.PLAYING",1);H("YT.PlayerState.PAUSED",2);H("YT.PlayerState.BUFFERING",3);H("YT.PlayerState.CUED",5);H("YT.get",function(a){return V[a]});
H("YT.scan",yb);H("YT.subscribe",function(a,b,c){U.subscribe(a,b,c);xb[a]=!0;for(var d in V)V.hasOwnProperty(d)&&Fb(V[d],a)});
H("YT.unsubscribe",function(a,b,c){lb(a,b,c)});
...
wb.push(function(a){var b=a;b||(b=document);a=za(b.getElementsByTagName("yt:player"));var c=b||document;if(c.querySelectorAll&&c.querySelector)b=c.querySelectorAll(".yt-player");else{var d;c=document;b=b||c;if(b.querySelectorAll&&b.querySelector)b=b.querySelectorAll(".yt-player");else if(b.getElementsByClassName){var g=b.getElementsByClassName("yt-player");b=g}else{g=b.getElementsByTagName("*");var k={};for(c=d=0;b=g[c];c++){var e=b.className,f;if(f=typeof e.split=="function")f=va(e.split(/\s+/),
"yt-player")>=0;f&&(k[d++]=b)}k.length=d;b=k}}b=za(b);wa(ya(a,b),Ob)});
typeof YTConfig!=="undefined"&&YTConfig.parsetags&&YTConfig.parsetags!=="onload"||yb();var Qb=F.onYTReady;Qb&&Qb();var Rb=F.onYouTubeIframeAPIReady;Rb&&Rb();var Sb=F.onYouTubePlayerAPIReady;Sb&&Sb();}).call(this);
